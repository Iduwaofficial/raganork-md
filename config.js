...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Souravkl11;94723418093;https://i.imgur.com/st4R2dq.jpeg;https://chat.whatsapp.com/GRzfk5m7ldFEbORdKRMdX5',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Idu bot',
    ...
    SUDO: process.env.SUDO || '94723418093,0',
